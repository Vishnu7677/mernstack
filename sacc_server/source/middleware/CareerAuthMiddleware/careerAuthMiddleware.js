...
function verifyCareerUserJWT(req, res, next) {
  ...
  const { status, data, message } = JWTService.verifyToken(token, 'CareerUser'); // Expecting the role to be 'admin'
...
module.exports = verifyCareerUserJWT;
